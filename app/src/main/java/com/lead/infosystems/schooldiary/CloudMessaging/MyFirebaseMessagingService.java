...
import com.lead.infosystems.schooldiary.Events.EventDailog;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void forNotificationTab(Map<String, String> data){
        ...
        sendNotification("NEW "+data.get(NOTIFICATION_TYPE).replace("_"," "),data.get(NOTIFICATION_TEXT).replace("+"," "),intent,NOTIFICATION_ID);
    }
